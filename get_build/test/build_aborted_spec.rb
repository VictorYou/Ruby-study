...
describe "test AllBuildInfo class to get build res_id" do
  it "should return aborted build url when former build is aborted at the same time for a different module" do
    ...
    @tester = AllBuildInfo.new(['eslinb86.emea.nsn-net.net'], ['GATE-med_core3-component-build-deploy-test'])
    @tester.expects(:log).returns(true)
    @tester.expects(:log).returns(true)
    @tester.expects(:log).returns(true)
    @tester.expects(:log).returns(true)
    expect(@tester.get_aborted_build([{'GATE-nass-component-build-deploy-test'=>[{:url => 'https://eslinb86.emea.nsn-net.net:8080/job/GATE-nass-component-build-deploy-test/1047', :module_to_build => '/workspace/netact/nass/SMU/implementation', :change => '184333', :change_ids => '184332,1 184333,1', :result => 'ABORTED', :end_time => '10:29:39', :res_id => 'nass/smu_platform1_git/18.0.0.96', :duration => '1 min 15 sec'}, {:url => 'https://eslinb86.emea.nsn-net.net:8080/job/GATE-nass-component-build-deploy-test/1046', :module_to_build => '/workspace/netact/nass/SMU1/implementation', :change => '184332', :change_ids => '184332,1', :result => 'ABORTED', :end_time => '10:29:39', :res_id => 'nass/smu_platform1_git/18.0.0.95'}]}])).to eq ([{:url => 'https://eslinb86.emea.nsn-net.net:8080/job/GATE-nass-component-build-deploy-test/1047', :duration => '1 min 15 sec', :module=>"/workspace/netact/nass/SMU/implementation", :previous_url=> "https://eslinb86.emea.nsn-net.net:8080/job/GATE-nass-component-build-deploy-test/1046", :previous_module=>"/workspace/netact/nass/SMU1/implementation"}])
  end

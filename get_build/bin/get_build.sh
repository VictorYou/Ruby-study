...
get_builds.rb -s ../conf/sonar_projects.chengdu
mv sonar_builds_ut sonar_builds_ut.chengdu.csv

get_builds.rb -s ../conf/sonar_projects.all
mv sonar_builds_ut sonar_builds_ut.all.csv

get_builds.rb -j ../conf/jenkins_servers.all -J ../conf/jenkins_jobs.chengdu -A -d "$date" -a -S
...
get_builds.rb -j ../conf/jenkins_servers.all -J ../conf/jenkins_jobs.all -A -d "$date" -a -S
